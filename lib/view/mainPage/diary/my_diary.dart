...
class _MyDiaryState extends State<MyDiary> {
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Consumer<DiaryViewModel>(builder: (context, provider, child) {
            ...
            actions: [
              SizedBox(
                ...
                child: TextField(
                  ...
                  decoration: DesignInputDecoration(hintText: '검색 단어 입력', icon: const Icon(Icons.search), circular: 5, hintCount: '').inputDecoration,
                  onChanged: (value) {
                    setState(() {
